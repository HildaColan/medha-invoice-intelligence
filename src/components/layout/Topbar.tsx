...
import { Bell, CheckCircle2, KeyRound, LogOut, Search, UserCircle2, XCircle } from "lucide-react";
...
export function Topbar() {
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (e: MouseEvent) => {
      ...
      const ref = openPanel === "notif" ? notifRef : profileRef;
        ...
        <div className="relative" ref={profileRef}>
          ...
          {openPanel === "profile" && (
            ...
            >
              ...
              <button
                onClick={() => { setOpenPanel(null); setPwModalOpen(true); }}
                className="w-full flex items-center gap-2.5 px-4 py-2.5 text-left hover:bg-[#F5EDE4]"
              >
                <KeyRound size={15} color={T.slateSoft} />
